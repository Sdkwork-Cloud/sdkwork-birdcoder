...
import { IThread, IProject } from 'sdkwork-ide-types';
...
export function TopBar({ currentProject, selectedThread, activeTab, setActiveTab, isTerminalOpen, setIsTerminalOpen }: TopBarProps) {
