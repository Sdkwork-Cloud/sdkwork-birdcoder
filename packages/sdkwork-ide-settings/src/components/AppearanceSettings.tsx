...
export function AppearanceSettings({ settings, updateSetting }: SettingsProps) {
  ...
  const handleImportTheme = () => {
    try {
      ...
      addToast(`Successfully imported ${importThemeType} theme.`, 'success');
      setIsImportModalOpen(false);
      setImportThemeData('');
    } catch (e) {
      addToast('Invalid theme JSON data.', 'error');
    }
  };
      ...
      <div className="max-w-3xl mx-auto animate-in fade-in slide-in-from-bottom-4 fill-mode-both" style={{ animationDelay: '0ms' }}>
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <div className="text-sm text-gray-500">Use light, dark, or match system settings</div>
          </div>
        ...
        <div className="bg-[#18181b] rounded-xl border border-white/10 overflow-hidden mb-8">
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <Button variant="link" className="h-auto p-0 text-gray-400 hover:text-white" onClick={() => {
                  ...
                  addToast('Light theme copied to clipboard.', 'success');
                }}>Copy theme</Button>
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <Button variant="link" className="h-auto p-0 text-gray-400 hover:text-white" onClick={() => {
                  ...
                  navigator.clipboard.writeText(JSON.stringify(themeData, null, 2));
                  addToast('Dark theme copied to clipboard.', 'success');
                }}>Copy theme</Button>
                <div className="relative">
                  <select 
          ...
          <div className="flex items-center justify-between p-4 border-b border-white/10">
            <div>
              <div className="text-white font-medium">Use pointer cursor</div>
              <div className="text-sm text-gray-500">Switch to pointer cursor when hovering interactive elements</div>
            </div>
            <div 
          ...
          <div className="flex items-center justify-between p-4 border-b border-white/10">
            <div>
              <div className="text-white font-medium">UI font size</div>
              <div className="text-sm text-gray-500">Adjust the base size used for the Codex UI</div>
            </div>
            <div className="flex items-center gap-2">
              <input 
                type="number" 
          ...
          <div className="flex items-center justify-between p-4 border-b border-white/10">
            <div>
              <div className="text-white font-medium">Code font size</div>
              <div className="text-sm text-gray-500">Adjust the base size used for code across chats and diffs</div>
            </div>
            <div className="flex items-center gap-2">
              <input 
                type="number" 
          ...
          <div className="flex items-center justify-between p-4 border-b border-white/10">
            <div>
              ...
              <div className="text-sm text-gray-500">Display line numbers in code editors and diffs</div>
            </div>
            <div 
          ...
          <div className="flex items-center justify-between p-4 border-b border-white/10">
            <div>
              ...
              <div className="text-sm text-gray-500">Wrap lines that exceed the width of the editor</div>
            </div>
            <div 
          ...
          <div className="flex items-center justify-between p-4">
            <div>
              ...
              <div className="text-sm text-gray-500">Show a minimap overview of the code</div>
            </div>
            <div 
      ...
      {isImportModalOpen && (
        <div className="absolute inset-0 bg-black/50 flex items-center justify-center z-50">
          <div className="w-[500px] bg-[#18181b] border border-white/10 rounded-xl shadow-2xl flex flex-col animate-in fade-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between p-4 border-b border-white/10">
              <h3 className="text-sm font-medium text-gray-200">Import {importThemeType === 'light' ? 'Light' : 'Dark'} Theme</h3>
            ...
            <div className="p-4 flex flex-col gap-4">
              <div>
                <label className="block text-xs font-medium text-gray-400 mb-1.5">Theme JSON Data</label>
                <textarea 
              ...
              <div className="flex justify-end gap-2 mt-2">
                ...
                <Button size="sm" className="bg-blue-600 hover:bg-blue-500 text-white" onClick={handleImportTheme}>Import</Button>
              </div>
            </div>
          </div>
        </div>
