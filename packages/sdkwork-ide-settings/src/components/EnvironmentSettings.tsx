      ...
      <div className="max-w-3xl mx-auto animate-in fade-in slide-in-from-bottom-4 fill-mode-both" style={{ animationDelay: '0ms' }}>
        ...
        <div className="bg-[#18181b] rounded-xl border border-white/10 overflow-hidden mb-8">
          <div className="flex items-center justify-between p-4 border-b border-white/10">
            <div>
              <div className="text-white font-medium">Node.js version</div>
              <div className="text-sm text-gray-500">Node.js version used in the current workspace.</div>
            </div>
          ...
          <div className="flex items-center justify-between p-4 border-b border-white/10">
            <div>
              <div className="text-white font-medium">Package manager</div>
              <div className="text-sm text-gray-500">Default package manager to use.</div>
            </div>
            <div className="relative">
              <select 
          ...
          <div className="p-4">
            <div className="flex items-center justify-between mb-4">
              <div>
                <div className="text-white font-medium">Environment variables</div>
                <div className="text-sm text-gray-500">Manage workspace environment variables (.env).</div>
              </div>
              {isEditing ? (
            ...
            {isEditing ? (
              ...
              <div className="w-full bg-black/30 border border-white/5 rounded-lg p-3 text-sm text-gray-400 font-mono whitespace-pre-wrap">
                {envContent || <span className="text-gray-600 italic">No environment variables defined.</span>}
              </div>
            )}
          </div>
        </div>
