  ...
  return (
    <div className="flex-1 overflow-y-auto p-12 bg-[#0e0e11]">
      <div className="max-w-3xl mx-auto animate-in fade-in slide-in-from-bottom-4 fill-mode-both" style={{ animationDelay: '0ms' }}>
        <h1 className="text-2xl font-semibold text-white mb-8">Git Settings</h1>
        
        <div className="bg-[#18181b] rounded-xl border border-white/10 overflow-hidden mb-8">
          <div className="flex items-center justify-between p-4 border-b border-white/10">
            <div>
              <div className="text-white font-medium">Auto Fetch</div>
              <div className="text-sm text-gray-500">Periodically fetch updates from remote repositories.</div>
            </div>
            <div 
          ...
          <div className="flex items-center justify-between p-4 border-b border-white/10">
            <div>
              <div className="text-white font-medium">Commit message generation</div>
              <div className="text-sm text-gray-500">Use AI to automatically generate commit messages.</div>
            </div>
            <div 
          ...
          <div className="flex items-center justify-between p-4">
            <div>
              <div className="text-white font-medium">Default branch name</div>
              <div className="text-sm text-gray-500">Default branch name when creating a new repository.</div>
            </div>
            <input 
              type="text" 
