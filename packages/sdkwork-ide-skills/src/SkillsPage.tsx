...
const REGISTRIES = [
  { id: 'official', name: '官方镜像 (Official)', url: 'https://registry.sdkwork.com' },
  { id: 'aliyun', name: '阿里云 (Alibaba Cloud)', url: 'https://mirrors.aliyun.com/sdkwork' },
  { id: 'tencent', name: '腾讯云 (Tencent Cloud)', url: 'https://mirrors.cloud.tencent.com/sdkwork' },
  { id: 'volcengine', name: '火山引擎 (Volcengine)', url: 'https://mirrors.volcengine.com/sdkwork' },
];
...
export function SkillsPage() {
  ...
  const [selectedRegistry, setSelectedRegistry] = useState(() => {
    const saved = localStorage.getItem('sdkwork_registry');
    if (saved) {
      const found = REGISTRIES.find(r => r.id === saved);
  ...
  useEffect(() => {
    localStorage.setItem('sdkwork_registry', selectedRegistry.id);
  }, [selectedRegistry]);
            ...
            <>
              ...
              <div className="relative mb-6 group">
                ...
                <input 
                  ref={searchInputRef}
                  type="text" 
                  placeholder="Search skills, packages, and integrations... (Press ⌘K)" 
                  value={searchQuery}
